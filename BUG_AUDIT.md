...
### From dashboard data (Stage 3+ telemetry)

| #     | Area      | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             | Status                                                                                                                                                                                                                                                                                                                                                                     |
| ----- | --------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P1-16 | Analytics | `close_calls_in_run` is flowing in _current_ builds (post-session-10 wiring) — `kpi_overview.mean_close_calls_per_run` reads 0.75 — but is **below the ≥1.0 engagement target**. Pre-instrumentation runs from earlier builds also pollute the all-time average (the field is absent from those rows; `kpi_overview()` filters them out via `payload ? 'close_calls_in_run'`, but the segment cutoff isn't documented). Two questions: (a) is 0.75 a real signal that close-calls are too rare in actual play, or (b) is some part of the instrumentation under-counting (e.g. only one of `'L'` / `'R'` engine emission sites firing)? | Sample 5 recent `run_end` rows: confirm `close_calls_in_run` key is present and roughly tracks the engine emissions per run. If under-counting confirmed, audit `src/features/game/engine/step.ts:153,160` close-call emission sites and `useGameLoop.ts` `closeCallsInRunRef` increment path. If accurate, this is a design signal, not a bug — kick to FEEDBACK_BACKLOG. |
